...
st.set_page_config(page_title="🎓 Education and Work", page_icon=":graduation_cap:", layout="wide")
...
- ESE6500: Learning in Robotics
  ...
  Kalman filter, SLAM, NeRFs, control planning, and reinforcement learning
...
Year 3:
- Group software project using Java: 
"""
